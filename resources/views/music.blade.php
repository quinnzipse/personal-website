...
<head>
    ...
    <style>
        ...
        #button_grid .custom-button:hover {
            color: whitesmoke;
            background-color: rgba(0, 0, 0, .7);
        }

        #button_grid .cb-hover:hover > .button-desc {
            width: 160px;
        }
...
<main id="app">
    ...
    <div id="side_menu">
        ...
        <div id="history" class="c-menus">
            ...
            <div class="pr-3" style="max-height: 90vh !important; overflow-y: auto">
                @foreach($recently_played->items as $item)
                    ...
                    @endphp
                    <h5 class="text-spotify mt-3 mb-0 text-truncate">{{$item->track->name}}</h5>
                    <span class="text-white">{{join(', ', $artists)}}</span>
                @endforeach
            </div>
        ...
        @if(!$error)
            <div id="buttons">
                <div id="button_grid">
                    ...
                    <div class="custom-button cb-hover" id="history_btn">
                    ...
                    <div class="custom-button cb-hover" id="queue_btn">
...
<script>
    ...
    function openMenu(option) {
        ...
        $('#button_grid').children().addClass('ccvd-button');
        $('#button_grid').children().removeClass('cb-hover');
    }
    ...
    function closeMenu() {
        ...
        $('#button_grid').children().removeClass('ccvd-button').addClass('cb-hover');
    }
